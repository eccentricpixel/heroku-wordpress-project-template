...
function appBase_active_nav_class( $classes, $item ) {
    if ( $item->current == 1 || $item->current_item_ancestor == true ) {
        $classes[] = 'active';
    }
    return $classes;
}
add_filter( 'nav_menu_css_class', 'appBase_active_nav_class', 10, 2 );

/**
 * Use the active class of ZURB Foundation on wp_list_pages output.
 * From required+ Foundation http://themes.required.ch
 */
function appBase_active_list_pages_class( $input ) {
...
add_filter( 'wp_list_pages', 'appBase_active_list_pages_class', 10, 2 );

/**
 * class appBase_walker
 ...
 * From required+ Foundation http://themes.required.ch
 */
class appBase_walker extends Walker_Nav_Menu {
